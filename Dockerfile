...
# docker build -t docusign_demo_application .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name docusign_demo_application docusign_demo_application
